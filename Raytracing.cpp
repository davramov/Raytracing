...
void scene1() {
    ...
    auto quad_material = make_shared<metal>(color(0.7, 0.2, 0.4), 0.4);
    ...
    auto difflight = make_shared<diffuse_light>(color(1, 1, 0.9));

    world.add(make_shared<sphere>(point3(0.0, 0.0, -1.0), 110, difflight));
    world.add(make_shared<sphere>(point3(0.0, 0.0, -1.0), 105, material_center));
    world.add(make_shared<sphere>(point3(0.0, 0.0, -1.0), -104, material_center));
    ...
    shared_ptr<hittable> box1 = box(point3(0, 0, 0), point3(0.5, 0.5, 0.5), quad_material);
    box1 = make_shared<translate>(box1, vec3(-1, -0.5, 1));
